...
class CourseGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Course entity")
        ...
        .repeat(2) {
            ...
            .get("/jhipstermicroservice1/api/courses")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new course")
            .post("/jhipstermicroservice1/api/courses")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/jhipstermicroservice1${new_course_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created course")
            .delete("/jhipstermicroservice1${new_course_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
