package com.jalaj.jhipstermicroservice1.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.getMapConfigs().put("com.jalaj.jhipstermicroservice1.domain.*", initializeDomainMapConfig(jHipsterProperties));
